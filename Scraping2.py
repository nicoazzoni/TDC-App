...
def ejecutar_scraping(años, trimestres, municipio, anexo):
    ...
    total_pasos = len(años) * len(trimestres)
    ...
    for año in años:
        for trimestre in trimestres:
            ...
            paso_actual += 1
            # Actualizo barra y texto general
            status_text.text(f"Extrayendo información... {paso_actual} de {total_pasos}")
            progress_bar.progress(int(paso_actual / total_pasos * 100))
